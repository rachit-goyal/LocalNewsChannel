...
class CustomSwipeAdapter extends PagerAdapter {
    ...
    CustomSwipeAdapter(ArrayList<res> resArrayList, Context context) {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        final ImageView imgshare = (ImageView) item_view.findViewById(R.id.imgshare);
        ...
        for (int i = 0; i < resArrayList.get(position).getAbc().get(0).getTgs().size(); i++) {
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    i.putExtra("tag_ids", tv.getTag().toString().substring(0, tv.getTag().toString().indexOf('.')));
                    i.putExtra("tag_name", tv.getText().toString());
