...
public class Contact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isNetworkAvailable()){
            ...
            Toast.makeText(Contact.this,"No Network",Toast.LENGTH_SHORT).show();
        }
    ...
    private void getdata() {
        ...
        this.dialog.show();
        String url="http://tajtodaynews.com/wp-json/wp/v2/pages/548";
        StringRequest str=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(error instanceof NoConnectionError){
                    ...
                    Toast.makeText(Contact.this,"Some error occurred please try after some time.",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private boolean isNetworkAvailable() {
        ConnectivityManager connectivityManager
                = (ConnectivityManager) Contact.this.getSystemService(Context.CONNECTIVITY_SERVICE);
